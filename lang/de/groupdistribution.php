...
$string['rate_group_not_saved'] = "Sie haben für diese Gruppe noch keine Bewertung abgegeben";
...
$string['view_distribution_table'] = 'Zeigt wie viele Studenten in eine Gruppe mit einer bestimmten Bewertung gekommen sind.';
$string['view_ratings_table'] = 'Zeigt die abgegebenen Bewertungen aller Studenten in einer Tabelle.';
$string['view_ratings_table_explanation'] = 'Diese Tabelle zeigt alle abgegebenen Bewertungen. Eine Bewertung mit einem Rahmen bedeutet, dass der Student in die entsprechende Gruppe eingetragen ist beziehungsweise eingetragen wurde.';
