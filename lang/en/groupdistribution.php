...
$string['max_timelimit_description'] = 'This controls after how many seconds the distribution algorithm gets interupted by php. If teachers need more time to compute their distributions you can increase this value.';
