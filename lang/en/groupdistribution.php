...
$string['rate_group_not_saved'] = "Please rate your preference to participate";
$string['rateable_form'] = 'Can students view and rate this group via Groupdistribution?';
$string['rateable_groups'] = 'Available Groups';
$string['rating_0'] = "I can't participate (0)";
$string['rating_1'] = "I don't want to participate, unless I have no choice (1)";
$string['rating_2'] = "I'd rather not participate (2)";
$string['rating_3'] = "I can participate (3)";
$string['rating_4'] = "I'd like to participate (4)";
$string['rating_5'] = "I really want to participate (5)";
...
$string['view_distribution_table'] = 'Shows how many students got into a group with a specific rating. High ratings are better.';
...
$string['your_groups'] = 'Your groups';
