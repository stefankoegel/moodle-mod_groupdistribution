...
$string['invalid_timeout'] = 'Please enter a number between 0 and {$a}.';
$string['max_timeout'] = 'Groupdistribution maximum timeout';
$string['max_timeout_description'] = 'Teachers can change the default php timeout form 30 seconds to a longer time because the distribution algorithm might take longer than that. To prevent abuse you can change the maxium amount of extra seconds here.';
