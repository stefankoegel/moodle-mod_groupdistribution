...
$string['rate_group'] = "Please rate this group (Your rating has been saved)";
$string['rate_group_help'] = "The better the rating, the higher are your chance to be distributed in this group.";
$string['rate_group_not_saved'] = "Please rate this group (You have not yet rated this group)";
...
$string['ratings_table'] = 'This table shows all ratings given by users. A rating with a border means, that the student is a member in the corresponding group.';
